...
const labFallback = [
  { slug: 'sakuga-spark', name: '作画火花', description: '高能关键帧与冲击节奏实验。', accent: '#f2674a', glyph: '✦' },
  { slug: 'panel-punch', name: '分镜重击', description: '漫画节奏、强切与图形转场实验。', accent: '#f4b942', glyph: '▦' },
  { slug: 'frame-mold', name: '帧塑', description: '一帧一帧建立形状语言。', accent: '#8bd5ca', glyph: '◈' },
  { slug: 'pixelpulse', name: '像素脉冲', description: '微小像素、强烈节拍与清晰循环。', accent: '#74a9ff', glyph: '▥' },
  { slug: 'inkdrift', name: '墨迹漂移', description: '像呼吸一样流动的有机线条。', accent: '#c69cff', glyph: '〰' },
  { slug: 'motion-rift', name: '动势裂隙', description: '拉伸、拖影与姿态之间的空间弯折。', accent: '#ff7eb6', glyph: '◒' }
];
